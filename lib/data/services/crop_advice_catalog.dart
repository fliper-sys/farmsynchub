...
class CropAdviceCatalog {
  ...
  static const List<CropAdviceProfile> _profiles = <CropAdviceProfile>[
    ...
    CropAdviceProfile(
      name: 'Fonio',
      aliases: <String>['fonio', 'acha'],
      seedRatePerHa: 12,
      seedUnit: 'kg',
      fertiliserSummary: 'Use a light basal fertiliser; fonio grows well on poor soils and rarely needs heavy nitrogen.',
      otherInputs: <String>['Fine seedbed', 'Weed control', 'Bird scaring'],
      stageAdvice: _cerealAdvice,
      reminderOffsetsDays: <int>[0, 7, 21, 35, 55],
      hasPostEmergenceHerbicide: true,
      referenceNote: 'A hardy short-cycle cereal; timely harvest matters because grains shatter easily.',
    ),
    CropAdviceProfile(
      name: 'Cocoyam',
      aliases: <String>['cocoyam', 'taro'],
      seedRatePerHa: 12000,
      seedUnit: 'cormels',
      fertiliserSummary: 'Apply basal fertiliser at planting and top dress with potassium as corms bulk.',
      otherInputs: <String>['Healthy cormels', 'Mulch', 'Weed control'],
      stageAdvice: _rootAdvice,
      reminderOffsetsDays: <int>[0, 21, 45, 75, 120],
      hasPostEmergenceHerbicide: false,
      referenceNote: 'Prefers moist, shaded conditions and rich organic soil.',
    ),
    CropAdviceProfile(
      name: 'Water yam',
      aliases: <String>['water yam'],
      seedRatePerHa: 2500,
      seedUnit: 'setts',
      fertiliserSummary: 'Apply basal fertiliser after sprouting and support vine growth with balanced feeding.',
      otherInputs: <String>['Stake or trellis', 'Mulch', 'Weed control'],
      stageAdvice: _rootAdvice,
      reminderOffsetsDays: <int>[0, 30, 60, 90, 120],
      hasPostEmergenceHerbicide: false,
      referenceNote: 'Needs strong staking and consistent moisture for good tuber size.',
    ),
    CropAdviceProfile(
      name: 'Kola nut',
      aliases: <String>['kola', 'kolanut', 'kola nut'],
      seedRatePerHa: 400,
      seedUnit: 'seedlings',
      fertiliserSummary: 'Use establishment fertiliser at planting and annual top dressing as trees mature.',
      otherInputs: <String>['Shade during establishment', 'Pruning', 'Weed control'],
      stageAdvice: _treeAdvice,
      reminderOffsetsDays: <int>[0, 30, 120, 240],
      hasPostEmergenceHerbicide: false,
      referenceNote: 'A slow-maturing tree crop; focus on shade management while young.',
    ),
    CropAdviceProfile(
      name: 'Coffee',
      aliases: <String>['coffee'],
      seedRatePerHa: 2500,
      seedUnit: 'seedlings',
      fertiliserSummary: 'Use basal feeding at transplant, then split nitrogen and potassium as trees enter bearing.',
      otherInputs: <String>['Shade trees', 'Pruning', 'Berry borer scouting'],
      stageAdvice: _treeAdvice,
      reminderOffsetsDays: <int>[0, 30, 120, 240],
      hasPostEmergenceHerbicide: false,
      referenceNote: 'Does well in Plateau highland conditions with cooler temperatures and good shade.',
    ),
    CropAdviceProfile(
      name: 'Tiger nut',
      aliases: <String>['tiger nut', 'tigernut', 'aya'],
      seedRatePerHa: 60,
      seedUnit: 'kg tubers',
      fertiliserSummary: 'Use a light basal fertiliser; tiger nut tolerates poor soils and rarely needs heavy feeding.',
      otherInputs: <String>['Fine seedbed', 'Weed control', 'Rodent control'],
      stageAdvice: _rootAdvice,
      reminderOffsetsDays: <int>[0, 21, 45, 75, 110],
      hasPostEmergenceHerbicide: true,
      referenceNote: 'Loose, sandy soil gives the best tuber yield and easier harvesting.',
    ),
    CropAdviceProfile(
      name: 'Hibiscus',
      aliases: <String>['hibiscus', 'zobo', 'roselle'],
      seedRatePerHa: 5,
      seedUnit: 'kg',
      fertiliserSummary: 'Use a light basal fertiliser and avoid excess nitrogen so calyx quality stays high.',
      otherInputs: <String>['Weed control', 'Drying mats', 'Pest scouting'],
      stageAdvice: _legumeAdvice,
      reminderOffsetsDays: <int>[0, 14, 35, 60, 90],
      hasPostEmergenceHerbicide: true,
      referenceNote: 'Harvest calyces promptly and dry well to protect colour and value.',
    ),
    CropAdviceProfile(
      name: 'Moringa',
      aliases: <String>['moringa'],
      seedRatePerHa: 10000,
      seedUnit: 'seedlings',
      fertiliserSummary: 'Use light basal feeding at planting; moringa is hardy and responds well to organic manure.',
      otherInputs: <String>['Weed control', 'Pruning for leaf harvest', 'Watering during establishment'],
      stageAdvice: _treeAdvice,
      reminderOffsetsDays: <int>[0, 21, 45, 75],
      hasPostEmergenceHerbicide: false,
      referenceNote: 'Fast-growing and drought-tolerant; regular pruning encourages leaf production.',
    ),
    CropAdviceProfile(
      name: 'Fluted pumpkin',
      aliases: <String>['fluted pumpkin', 'ugu'],
      seedRatePerHa: 20,
      seedUnit: 'kg seed',
      fertiliserSummary: 'Use moderate basal fertiliser and light top dressing between cuttings.',
      otherInputs: <String>['Trellis or mulch', 'Weed control', 'Watering'],
      stageAdvice: _vegetableAdvice,
      reminderOffsetsDays: <int>[0, 14, 28, 42, 56],
      hasPostEmergenceHerbicide: false,
      referenceNote: 'A cut-and-come-again leafy vine; frequent harvest keeps vines productive.',
    ),
    CropAdviceProfile(
      name: 'Beetroot',
      aliases: <String>['beetroot', 'beet'],
      seedRatePerHa: 8,
      seedUnit: 'kg seed',
      fertiliserSummary: 'Use well-finished compost or basal fertiliser and keep potassium adequate for root colour.',
      otherInputs: <String>['Fine seedbed', 'Thinning', 'Weed control'],
      stageAdvice: _rootAdvice,
      reminderOffsetsDays: <int>[0, 14, 28, 45, 65],
      hasPostEmergenceHerbicide: false,
      referenceNote: 'Grows well in Plateau\'s cooler highland climate; keep soil loose for even roots.',
    ),
    CropAdviceProfile(
      name: 'Cauliflower',
      aliases: <String>['cauliflower'],
      seedRatePerHa: 0.5,
      seedUnit: 'kg seed',
      fertiliserSummary: 'Use strong basal feeding and follow with nitrogen and boron support during curd formation.',
      otherInputs: <String>['Nursery', 'Insect netting', 'Pest scouting'],
      stageAdvice: _vegetableAdvice,
      reminderOffsetsDays: <int>[0, 14, 28, 42, 60],
      hasPostEmergenceHerbicide: false,
      referenceNote: 'Prefers cooler highland temperatures; shade curds from direct sun as they form.',
    ),
    CropAdviceProfile(
      name: 'Green bean',
      aliases: <String>['green bean', 'french bean', 'string bean'],
      seedRatePerHa: 60,
      seedUnit: 'kg',
      fertiliserSummary: 'Use a light starter fertiliser and avoid excess nitrogen so flowering is not delayed.',
      otherInputs: <String>['Staking for climbers', 'Weed control', 'Pest scouting'],
      stageAdvice: _legumeAdvice,
      reminderOffsetsDays: <int>[0, 10, 22, 35, 48],
      hasPostEmergenceHerbicide: true,
      referenceNote: 'A short-cycle legume; pick pods regularly to keep plants producing.',
    ),
    CropAdviceProfile(
      name: 'Bell pepper',
      aliases: <String>['bell pepper', 'sweet pepper', 'tatashe'],
      seedRatePerHa: 0.3,
      seedUnit: 'kg seed',
      fertiliserSummary: 'Use basal fertiliser and support fruiting with potassium-rich feeding as fruit fills out.',
      otherInputs: <String>['Nursery', 'Staking', 'Pest scouting'],
      stageAdvice: _vegetableAdvice,
      reminderOffsetsDays: <int>[0, 18, 35, 50, 68],
      hasPostEmergenceHerbicide: false,
      referenceNote: 'Keep irrigation even and watch for blossom-end rot on developing fruit.',
    ),
  ];
